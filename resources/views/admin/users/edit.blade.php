<x-app-layout>
    ...
    <style>
        ...
        .toggle-password-btn {
            ...
            /* DITAMBAHKAN: Flex & Padding untuk konsistensi tinggi */
            display: flex;
            align-items: center;
            padding: 0.75rem 1rem !important; 
        }
        
        .toggle-password-btn:hover .toggle-icon {
            color: var(--ipb-blue) !important;
        }
        
        /* DITAMBAHKAN: Penyesuaian Vertikal untuk Ikon */
        .toggle-icon {
            /* Menggeser ikon ke atas sedikit agar terlihat mepet dengan input */
            margin-top: -2px; 
        }
            ...
            <div class="col-lg-7 col-md-9">
                <div class="modern-card">
                    ...
                    <div class="card-header-custom">
                        ...
                        <h4 class="fw-bold m-0 text-dark">Edit User Account</h4>
                    </div>
                    ...
                    <div class="card-body p-5">
                        <form action="{{ route('admin.users.update', $user->id) }}" method="POST">
                            ...
                            <h6 class="text-muted small fw-bold text-uppercase mb-4 mt-2">Change Password (Optional)</h6>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <span class="toggle-password-btn" data-target="#password">
                                ...
                                <div class="col-md-6 mb-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <span class="toggle-password-btn" data-target="#password_confirmation">
                                            <i class="fas fa-eye toggle-icon"></i>
                                        </span>
                                    </div>
                                </div>
                ...
                <div class="mt-4 p-4 text-center bg-white rounded-3 small text-muted border" style="border-radius: 1.25rem !important;">
                    <i class="fas fa-info-circle text-primary me-2"></i> Biarkan kolom password kosong jika Anda tidak ingin mengubah password saat ini.
                </div>
